...
def handle_response(message: str) -> str:
    ...
    if "privaat" in message or "sõber" in message:
        return random.choice(["Privaatsõnume? Vabandust.", "Tere! Selle aine mul on kõik korras ja ma läbitud eelmisel semestril diskreetne matemaatika aine Harri Lensile ja mul on hinne 1 kõik korras läbitud kursuse. Kellele on vaja abi kirjutada mulle privaat sõnume."])
